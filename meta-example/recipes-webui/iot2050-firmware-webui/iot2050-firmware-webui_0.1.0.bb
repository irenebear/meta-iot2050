...
DEPENDS = "iot2050-firmware-manager iot2050-cockpit-customization"
...
DEBIAN_DEPENDS = "cockpit, iot2050-firmware-manager, iot2050-cockpit-customization"
...
do_install() {
    ...
    install -v -m 644 ${WORKDIR}/firmware.js \
        ${D}/usr/share/cockpit/iot2050-firmware/
    install -v -m 644 ${WORKDIR}/siemens-logo.svg \
        ${D}/usr/share/cockpit/iot2050-firmware/
}
